-- Finalized Smart Parking System Schema
-- Run this in MySQL Workbench to set up a clean, fully-featured environment.

SET FOREIGN_KEY_CHECKS = 0;
DROP DATABASE IF EXISTS smartparking;
CREATE DATABASE smartparking CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE smartparking;
